...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(
        seconds=env.int("ACCESS_TOKEN_LIFETIME", default=900)
    ),  # 15분으로 수정
    "REFRESH_TOKEN_LIFETIME": timedelta(
        seconds=env.int("REFRESH_TOKEN_LIFETIME", default=604800)
    ),
    ...
    "AUTH_COOKIE_REFRESH": env(
        "AUTH_COOKIE_REFRESH", default="gobooky-refresh"
    ),  # Refresh token만 HttpOnly 쿠키
...
# Audio book files
AUDIOBOOK_URL = "/audio_book/"
AUDIOBOOK_ROOT = BASE_DIR / "audio_book"
...
CACHE_TTL = env.int("CACHE_TTL", default=15)  # 15 minutes
CACHE_KEY_PREFIX = env("CACHE_KEY_PREFIX", default="gobooky")
